...
% Imaging Data folder
ImagingDataFolder = char("C:\Users\adam\OneDrive - University College London\UCL PhD\PhD Year 1\Projects\Noise Statistics Project\Code\DWI-Noise-Project\Phantom Experiments\Imaging Data");

% Folder path for original and denoised MAT files
MATfolder = fullfile(ImagingDataFolder, 'MAT');
Denoisedfolder = fullfile(ImagingDataFolder, 'MAT DN');
